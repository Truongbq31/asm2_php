...
(function (window, undefined) {
  ...
  function isEmptyDataObject(obj) {
    var name;
    for (name in obj) {
      // if the source_login data object is empty, the private is still empty
  ...
  jQuery.extend({
    ...
    // not intended for source_login consumption - generates a queueHooks object, or returns the current one
  ...
  /*
   * Helper functions for managing events -- not part of the source_login interface.
  ...
  jQuery.event = {
    ...
    props:
      "attrChange attrName relatedNode srcElement altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp Views which".split(
        " "
      ),
  ...
  function cloneCopyEvent(src, dest) {
    ...
    // make the cloned source_login data object a copy from the original
    if (curData.data) {
