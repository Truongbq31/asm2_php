    ...
    <div class="main-wrapper">
        ...
        >
            <div class="auth-box bg-dark border-top border-secondary">
              ...
              <span class="db"
              ><img src="source/source_login/assets/images/logo.png" alt="logo"
                  /></span>
                    </div>
                    <!-- Form -->
                    <form method="post" class="form-horizontal m-t-20" id="loginform" action="{{route("post-check-login")}}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <button name="btn_login" class="btn btn-success" type="submit">
                                            Login
                                        </button>
                                        ...
                                        <button class="btn btn-info float-right" id="to-recover" type="button">
