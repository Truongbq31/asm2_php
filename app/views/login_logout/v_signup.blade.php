    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
        <div class="auth-box bg-dark border-top border-secondary">
            <div>
                ...
                <!-- Form -->
                <form method="post" class="form-horizontal m-t-20" action="{{route('post-signup')}}">
                    ...
                    <div>
                        <a class="btn btn-success" href="{{route("login")}}" id="to-login" name="action">
                            Back To Login
                        </a>
                    </div>
